...
@variables Cum_Disc_Utility(t) = 0 [description = "Cum_Disc_Utility"]
...
@variables Factor_Productivity(t) = 1 [description = "Factor_Productivity"]
...
eqs = [
	...
	CO2_Rad_Forcing ~ (CO2_Rad_Force_Coeff) * (max((2) , ((CO2_in_Atmos) / (Preindustrial_CO2))))
